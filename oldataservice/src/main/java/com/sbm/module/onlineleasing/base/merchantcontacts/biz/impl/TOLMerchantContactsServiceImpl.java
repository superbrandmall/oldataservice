//package com.sbm.module.onlineleasing.base.merchantcontacts.biz.impl;
//
...
//import com.sbm.module.onlineleasing.base.merchantcontacts.biz.ITOLMerchantContactsService;
...
//public class TOLMerchantContactsServiceImpl extends DaoSupportServiceImpl<TOLMerchantContacts> implements
//		ITOLMerchantContactsService {
//
//	@Autowired
//	private ITOLMerchantContactsDao dao;
//
...
//		List<TOLMerchantContacts> list = dao.findAll();
//		return list;
//	}
//
//	@Transactional(value = TransactionConstant.OL, propagation = Propagation.NOT_SUPPORTED, readOnly = true)
