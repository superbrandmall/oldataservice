package com.sbm.module.onlineleasing.cache.bidparam.job.configuration;
 ...
 */
@Configuration
public class BidParamJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.bidparam.CRON_EXPRESSION']}")
	private String CRON_EXPRESSION;

	@Autowired
	@Qualifier("bidParamJob")
	private BaseJob job;

	@Bean(name = "bidParamJobDetail")
