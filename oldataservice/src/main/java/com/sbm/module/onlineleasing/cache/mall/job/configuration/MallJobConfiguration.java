package com.sbm.module.onlineleasing.cache.mall.job.configuration;
 ...
 */
@Configuration
public class MallJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.mall.CRON_EXPRESSION']}")
