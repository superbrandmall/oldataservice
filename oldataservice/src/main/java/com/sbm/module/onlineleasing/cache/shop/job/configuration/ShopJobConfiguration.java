package com.sbm.module.onlineleasing.cache.shop.job.configuration;
 ...
 */
@Configuration
public class ShopJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.shop.CRON_EXPRESSION']}")
