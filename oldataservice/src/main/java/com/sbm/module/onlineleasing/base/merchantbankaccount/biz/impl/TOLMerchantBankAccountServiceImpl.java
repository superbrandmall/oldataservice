...
public class TOLMerchantBankAccountServiceImpl extends DaoSupportServiceImpl<TOLMerchantBankAccount> implements
		ITOLMerchantBankAccountService {

	@Autowired
	private ITOLMerchantBankAccountDao dao;
	...
	public List<TOLMerchantBankAccount> findAll() {
		List<TOLMerchantBankAccount> list = dao.findAll();
		return list;
	}
