package com.sbm.module.onlineleasing.cache.mallinfo.job.configuration;
 ...
 */
@Configuration
public class MallInfoJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.mallinfo.CRON_EXPRESSION']}")
	private String CRON_EXPRESSION;

	@Autowired
	@Qualifier("mallInfoJob")
	private BaseJob job;

	@Bean(name = "mallInfoJobDetail")
