package com.sbm.module.onlineleasing.cache.floor.job.impl;
 ...
 */
@Configuration
public class FloorJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.floor.CRON_EXPRESSION']}")
