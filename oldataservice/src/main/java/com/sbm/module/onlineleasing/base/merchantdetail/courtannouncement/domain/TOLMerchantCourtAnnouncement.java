package com.sbm.module.onlineleasing.base.merchantdetail.courtannouncement.domain;
 ...
 * @author ：junkai.zhang
 */
@Entity(name = "TOLMerchantCourtAnnouncement")
@Table(name = "T_OL_MERCHANT_COURT_ANNOUNCEMENT")
public class TOLMerchantCourtAnnouncement extends BaseEntity {
