...
public class TOLMerchantBusinessLicenseServiceImpl extends DaoSupportServiceImpl<TOLMerchantBusinessLicense> implements
		ITOLMerchantBusinessLicenseService {

	@Autowired
	private ITOLMerchantBusinessLicenseDao dao;
	...
	public List<TOLMerchantBusinessLicense> findAll() {
		List<TOLMerchantBusinessLicense> list = dao.findAll();
		return list;
	}
