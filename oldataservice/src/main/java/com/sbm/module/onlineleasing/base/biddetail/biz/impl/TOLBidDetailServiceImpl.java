package com.sbm.module.onlineleasing.base.biddetail.biz.impl;
...
public class TOLBidDetailServiceImpl extends DaoSupportServiceImpl<TOLBidDetail> implements ITOLBidDetailService {

	@Autowired
	private ITOLBidDetailDao dao;
	...
	public List<TOLBidDetail> findAll() {
		List<TOLBidDetail> list = dao.findAll();
		return list;
	}
