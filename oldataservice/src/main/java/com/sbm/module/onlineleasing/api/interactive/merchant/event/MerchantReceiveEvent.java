package com.sbm.module.onlineleasing.api.interactive.merchant.event;
 ...
 * @author ：junkai.zhang
 */
public class MerchantReceiveEvent extends BusinessEvent implements ISendMailEvent, ISendSysMessageEvent {

	private static final long serialVersionUID = -8142497275838643406L;

	public MerchantReceiveEvent(BusinessEventTemplate template) {
		super(template);
	}
