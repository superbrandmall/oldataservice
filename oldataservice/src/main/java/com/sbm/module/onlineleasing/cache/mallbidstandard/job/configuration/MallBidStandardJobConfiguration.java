package com.sbm.module.onlineleasing.cache.mallbidstandard.job.configuration;
 ...
 */
@Configuration
public class MallBidStandardJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['onlineleasing.cache.mallbidstandard.CRON_EXPRESSION']}")
	private String CRON_EXPRESSION;

	@Autowired
	@Qualifier("mallBidStandardJob")
	private BaseJob job;

	@Bean(name = "mallBidStandardJobDetail")
	...
	// cron触发器配置
	@Bean(name = "mallBidStandardJobTrigger")
