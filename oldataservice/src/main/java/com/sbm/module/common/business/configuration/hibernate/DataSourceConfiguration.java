...
public class DataSourceConfiguration {
	...
	/*********************** 通用数据源 ********************************/
	/*
	 * @Value("#{propertiesReader['hibernate.connection.driver_class']}")
	 * private String driver_class;
	 */
	@Value("#{propertiesReader['hibernate.connection.url']}")
	private String url;
	@Value("#{propertiesReader['hibernate.connection.username']}")
	private String username;
	@Value("#{propertiesReader['hibernate.connection.password']}")
	private String password;
	@Value("#{propertiesReader['hibernate.connection.validationQuery']}")
