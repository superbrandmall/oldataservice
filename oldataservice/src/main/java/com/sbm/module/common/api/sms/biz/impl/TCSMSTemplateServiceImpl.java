...
public class TCSMSTemplateServiceImpl extends DaoSupportServiceImpl<TCSMSTemplate> implements ITCSMSTemplateService {

	@Autowired
	private ITCSMSTemplateDao dao;
	...
	public List<TCSMSTemplate> findAll() {
		List<TCSMSTemplate> list = dao.findAll();
		return list;
	}
	...
	public void saveSMSTemplate(TCSMSTemplate obj) {
		obj.setCode(serialCodeService.nextBizId(SerialCodeConstant.CSMSTEMP).getNextBizId());
		save(obj);
	}
