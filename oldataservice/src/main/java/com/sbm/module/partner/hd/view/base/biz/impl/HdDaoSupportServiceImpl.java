package com.sbm.module.partner.hd.view.base.biz.impl;
...
import com.sbm.module.common.business.biz.impl.AbstractDaoSupportServiceImpl;
...
public class HdDaoSupportServiceImpl<T> extends AbstractDaoSupportServiceImpl<T> implements IDaoSupportService<T> {

	@Autowired
	@Qualifier("hdBaseHibernateDaoImpl")
