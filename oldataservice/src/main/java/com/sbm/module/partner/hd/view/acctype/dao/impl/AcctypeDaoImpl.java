package com.sbm.module.partner.hd.view.acctype.dao.impl;
...
// ***************************************************************************/
@Repository
public class AcctypeDaoImpl extends HdBaseHibernateDaoImpl<Acctype> implements IAcctypeDao {

	public List<Acctype> findAll() {
		String hql = "from Acctype";
		List<Acctype> list = find(hql);
		return list;
	}

	public Acctype findByItemno(Integer itemno) {
		StringBuffer sb = new StringBuffer("from Acctype where 1=1 ");
		sb.append(" and itemno = ?");
		List<Acctype> list = find(sb.toString(), itemno);
