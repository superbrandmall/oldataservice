package com.sbm.module.partner.hd.job.shop.configuration;
 ...
 */
@Configuration
public class HdShopJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['hd.job.shop.CRON_EXPRESSION']}")
