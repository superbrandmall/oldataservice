package com.sbm.module.partner.hd.rest.contract.standard.biz;
 ...
 * @author ：junkai.zhang
 */
public interface IHdContractStandardSubmitService {

	HdResult<HdContractStandardResult> standardSubmit(HdContract hdContract);
