package com.sbm.module.partner.tianyancha.rest.dishonest.biz.impl;
 ...
 */
@Component
public class DishonestServiceImpl extends BusinessServiceImpl implements IDishonestService {

	@Autowired
	@Qualifier("tycRestTemplate")
	private RestTemplate restTemplate;

	private static final String METHOD = "/newopen/dishonest.json?name={0}&pageNum={1}";

	public void getVo(DishonestVo vo) {
		Dishonest result = findResultByName(vo.getName(), vo.getPageNum());
		vo.setResult(result);
	}
	...
	public Dishonest findResultByName(String name, Integer pageNum) {
		...
		Dishonest result = restTemplate.getForObject(uri, Dishonest.class);
