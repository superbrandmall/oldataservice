package com.sbm.module.partner.hd.job.modality.configuration;
 ...
 */
@Configuration
public class HdModalityJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['hd.job.modality.CRON_EXPRESSION']}")
	private String CRON_EXPRESSION;

	@Autowired
	@Qualifier("hdModalityJob")
	private BaseJob job;

	@Bean(name = "hdModalityJobDetail")
	...
	// cron触发器配置
	@Bean(name = "hdModalityJobTrigger")
