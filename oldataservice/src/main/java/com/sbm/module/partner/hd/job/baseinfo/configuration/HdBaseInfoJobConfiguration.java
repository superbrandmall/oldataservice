package com.sbm.module.partner.hd.job.baseinfo.configuration;
 ...
 */
@Configuration
public class HdBaseInfoJobConfiguration extends BaseJobConfiguration {

	@Value("#{propertiesReader['hd.job.baseinfo.CRON_EXPRESSION']}")
	private String CRON_EXPRESSION;

	@Autowired
	@Qualifier("hdBaseInfoJob")
	private BaseJob job;

	@Bean(name = "hdBaseInfoJobDetail")
	...
	// cron触发器配置
	@Bean(name = "hdBaseInfoJobTrigger")
