package com.sbm.module.partner.hd.rest.contract.preview.biz.impl;
 ...
 */
@Component
public class HdContractPreviewServiceImpl extends HdInteractiveServiceImpl implements IHdContractPreviewService {

	@Autowired
	@Qualifier("hdRestTemplate")
	private RestTemplate restTemplate;

//	private static final String METHOD = "/rest/onlineleasing/contract/previewIntention";
	private static final String METHOD = "/rest/onlineleasing/contract/previewIntention?time=2016-06-13  11:11:11&operator.id=lixiaohong&operator.fullname=李小红&operator.namespace=hd";
	...
	public HdResult<String> preview(HdContract hdContract) {
		...
		ResponseEntity<HdResult<String>> result = restTemplate.exchange(uri, HttpMethod.POST, entity,
				new ParameterizedTypeReference<HdResult<String>>() {
				});
