 ...
 * @author ：junkai.zhang
 */
public class ExecutionInfoData {

	private Integer total;

	private Integer pagesize;

	private List<ExecutionInfoItem> items;
	...
	public List<ExecutionInfoItem> getItems() {
		return items;
	}

	public void setItems(List<ExecutionInfoItem> items) {
		this.items = items;
	}
